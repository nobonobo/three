...
func (bg *BufferGeometry) BoundingBox() *math.Box3 {
	return &math.Box3{Value: bg.Get("boundingBox")}
}
func (bg *BufferGeometry) SetBoundingBox(v *math.Box3) {
	bg.Set("boundingBox", v)
}
func (bg *BufferGeometry) BoundingSphere() *math.Sphere {
	return &math.Sphere{Value: bg.Get("boundingSphere")}
}
func (bg *BufferGeometry) SetBoundingSphere(v *math.Sphere) {
...
func (bg *BufferGeometry) ApplyMatrix(matrix *math.Matrix4) *BufferGeometry {
...
func (bg *BufferGeometry) Clone() this {
...
func (bg *BufferGeometry) Copy(source *BufferGeometry) this {
...
func (bg *BufferGeometry) GetAttribute(name string) BufferAttribute {
	return BufferAttribute(bg.Call("getAttribute", name))
}
...
func (bg *BufferGeometry) LookAt(v *math.Vector3) {
	bg.Call("lookAt", v)
}
...
func (bg *BufferGeometry) RotateX(angle int) *BufferGeometry {
	return &BufferGeometry{Value: bg.Call("rotateX", angle)}
}
func (bg *BufferGeometry) RotateY(angle int) *BufferGeometry {
	return &BufferGeometry{Value: bg.Call("rotateY", angle)}
}
func (bg *BufferGeometry) RotateZ(angle int) *BufferGeometry {
	return &BufferGeometry{Value: bg.Call("rotateZ", angle)}
}
func (bg *BufferGeometry) Scale(x int, y int, z int) *BufferGeometry {
	return &BufferGeometry{Value: bg.Call("scale", x, y, z)}
}
func (bg *BufferGeometry) SetDrawRange(start int, count int) {
...
func (bg *BufferGeometry) SetFromPoints(points []math.Vector3) *BufferGeometry {
	return &BufferGeometry{Value: bg.Call("setFromPoints", points)}
}
func (bg *BufferGeometry) SetIndex(index BufferAttribute) {
...
func (bg *BufferGeometry) Translate(x int, y int, z int) *BufferGeometry {
