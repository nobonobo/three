...
func (rsm *RawShaderMaterial) AlphaTest() int {
	return rsm.Get("alphaTest").Int()
}
func (rsm *RawShaderMaterial) SetAlphaTest(v int) {
	rsm.Set("alphaTest", v)
}
func (rsm *RawShaderMaterial) BlendDst() *BlendingDstFactor {
	return &BlendingDstFactor{Value: rsm.Get("blendDst")}
}
func (rsm *RawShaderMaterial) SetBlendDst(v *BlendingDstFactor) {
	rsm.Set("blendDst", v)
}
func (rsm *RawShaderMaterial) BlendDstAlpha() int {
	return rsm.Get("blendDstAlpha").Int()
}
func (rsm *RawShaderMaterial) SetBlendDstAlpha(v int) {
	rsm.Set("blendDstAlpha", v)
}
func (rsm *RawShaderMaterial) BlendEquation() *BlendingEquation {
	return &BlendingEquation{Value: rsm.Get("blendEquation")}
}
func (rsm *RawShaderMaterial) SetBlendEquation(v *BlendingEquation) {
	rsm.Set("blendEquation", v)
}
func (rsm *RawShaderMaterial) BlendEquationAlpha() int {
	return rsm.Get("blendEquationAlpha").Int()
}
func (rsm *RawShaderMaterial) SetBlendEquationAlpha(v int) {
	rsm.Set("blendEquationAlpha", v)
}
func (rsm *RawShaderMaterial) BlendSrc() BlendingSrcFactor {
	return BlendingSrcFactor(rsm.Get("blendSrc"))
}
func (rsm *RawShaderMaterial) SetBlendSrc(v BlendingSrcFactor) {
	rsm.Set("blendSrc", v)
}
func (rsm *RawShaderMaterial) BlendSrcAlpha() int {
	return rsm.Get("blendSrcAlpha").Int()
}
func (rsm *RawShaderMaterial) SetBlendSrcAlpha(v int) {
	rsm.Set("blendSrcAlpha", v)
}
func (rsm *RawShaderMaterial) Blending() *Blending {
	return &Blending{Value: rsm.Get("blending")}
}
...
func (rsm *RawShaderMaterial) DepthFunc() *DepthModes {
	return &DepthModes{Value: rsm.Get("depthFunc")}
}
...
func (rsm *RawShaderMaterial) Linewidth() int {
	return rsm.Get("linewidth").Int()
}
func (rsm *RawShaderMaterial) SetLinewidth(v int) {
	rsm.Set("linewidth", v)
}
...
func (rsm *RawShaderMaterial) Opacity() int {
	return rsm.Get("opacity").Int()
}
func (rsm *RawShaderMaterial) SetOpacity(v int) {
	rsm.Set("opacity", v)
}
func (rsm *RawShaderMaterial) Overdraw() int {
	return rsm.Get("overdraw").Int()
}
func (rsm *RawShaderMaterial) SetOverdraw(v int) {
	rsm.Set("overdraw", v)
}
...
func (rsm *RawShaderMaterial) PolygonOffsetFactor() int {
	return rsm.Get("polygonOffsetFactor").Int()
}
func (rsm *RawShaderMaterial) SetPolygonOffsetFactor(v int) {
	rsm.Set("polygonOffsetFactor", v)
}
func (rsm *RawShaderMaterial) PolygonOffsetUnits() int {
	return rsm.Get("polygonOffsetUnits").Int()
}
func (rsm *RawShaderMaterial) SetPolygonOffsetUnits(v int) {
...
func (rsm *RawShaderMaterial) Side() *Side {
	return &Side{Value: rsm.Get("side")}
}
...
func (rsm *RawShaderMaterial) VertexColors() *Colors {
	return &Colors{Value: rsm.Get("vertexColors")}
}
...
func (rsm *RawShaderMaterial) WireframeLinewidth() int {
	return rsm.Get("wireframeLinewidth").Int()
}
func (rsm *RawShaderMaterial) SetWireframeLinewidth(v int) {
...
func (rsm *RawShaderMaterial) Clone() this {
	return this(rsm.Call("clone"))
}
func (rsm *RawShaderMaterial) Copy(material *Material) this {
	return this(rsm.Call("copy", material))
}
...
func (rsm *RawShaderMaterial) OnBeforeCompile(shader shaders.Shader, renderer *renderers.WebGLRenderer) {
