...
func NewMultiMaterial(materials []Material) *MultiMaterial {
	return &MultiMaterial{Value: get("MultiMaterial").New(materials)}
}
func (mm *MultiMaterial) AlphaTest() int {
	return mm.Get("alphaTest").Int()
}
func (mm *MultiMaterial) SetAlphaTest(v int) {
	mm.Set("alphaTest", v)
}
func (mm *MultiMaterial) BlendDst() *BlendingDstFactor {
	return &BlendingDstFactor{Value: mm.Get("blendDst")}
}
func (mm *MultiMaterial) SetBlendDst(v *BlendingDstFactor) {
	mm.Set("blendDst", v)
}
func (mm *MultiMaterial) BlendDstAlpha() int {
	return mm.Get("blendDstAlpha").Int()
}
func (mm *MultiMaterial) SetBlendDstAlpha(v int) {
	mm.Set("blendDstAlpha", v)
}
func (mm *MultiMaterial) BlendEquation() *BlendingEquation {
	return &BlendingEquation{Value: mm.Get("blendEquation")}
}
func (mm *MultiMaterial) SetBlendEquation(v *BlendingEquation) {
	mm.Set("blendEquation", v)
}
func (mm *MultiMaterial) BlendEquationAlpha() int {
	return mm.Get("blendEquationAlpha").Int()
}
func (mm *MultiMaterial) SetBlendEquationAlpha(v int) {
	mm.Set("blendEquationAlpha", v)
}
func (mm *MultiMaterial) BlendSrc() BlendingSrcFactor {
	return BlendingSrcFactor(mm.Get("blendSrc"))
}
func (mm *MultiMaterial) SetBlendSrc(v BlendingSrcFactor) {
	mm.Set("blendSrc", v)
}
func (mm *MultiMaterial) BlendSrcAlpha() int {
	return mm.Get("blendSrcAlpha").Int()
}
func (mm *MultiMaterial) SetBlendSrcAlpha(v int) {
	mm.Set("blendSrcAlpha", v)
}
func (mm *MultiMaterial) Blending() *Blending {
	return &Blending{Value: mm.Get("blending")}
}
...
func (mm *MultiMaterial) DepthFunc() *DepthModes {
	return &DepthModes{Value: mm.Get("depthFunc")}
}
...
func (mm *MultiMaterial) IsMultiMaterial() true {
	return true(mm.Get("isMultiMaterial"))
}
func (mm *MultiMaterial) SetIsMultiMaterial(v true) {
...
func (mm *MultiMaterial) Materials() []Material {
	return []Material(mm.Get("materials"))
}
func (mm *MultiMaterial) SetMaterials(v []Material) {
	mm.Set("materials", v)
}
...
func (mm *MultiMaterial) Opacity() int {
	return mm.Get("opacity").Int()
}
func (mm *MultiMaterial) SetOpacity(v int) {
	mm.Set("opacity", v)
}
func (mm *MultiMaterial) Overdraw() int {
	return mm.Get("overdraw").Int()
}
func (mm *MultiMaterial) SetOverdraw(v int) {
	mm.Set("overdraw", v)
}
...
func (mm *MultiMaterial) PolygonOffsetFactor() int {
	return mm.Get("polygonOffsetFactor").Int()
}
func (mm *MultiMaterial) SetPolygonOffsetFactor(v int) {
	mm.Set("polygonOffsetFactor", v)
}
func (mm *MultiMaterial) PolygonOffsetUnits() int {
	return mm.Get("polygonOffsetUnits").Int()
}
func (mm *MultiMaterial) SetPolygonOffsetUnits(v int) {
...
func (mm *MultiMaterial) VertexColors() *Colors {
	return &Colors{Value: mm.Get("vertexColors")}
}
...
func (mm *MultiMaterial) Clone() this {
	return this(mm.Call("clone"))
}
func (mm *MultiMaterial) Copy(material *Material) this {
	return this(mm.Call("copy", material))
}
...
func (mm *MultiMaterial) OnBeforeCompile(shader shaders.Shader, renderer *renderers.WebGLRenderer) {
...
func (pm *PointsMaterial) AlphaTest() int {
	return pm.Get("alphaTest").Int()
}
func (pm *PointsMaterial) SetAlphaTest(v int) {
	pm.Set("alphaTest", v)
}
func (pm *PointsMaterial) BlendDst() *BlendingDstFactor {
	return &BlendingDstFactor{Value: pm.Get("blendDst")}
}
func (pm *PointsMaterial) SetBlendDst(v *BlendingDstFactor) {
	pm.Set("blendDst", v)
}
func (pm *PointsMaterial) BlendDstAlpha() int {
	return pm.Get("blendDstAlpha").Int()
}
func (pm *PointsMaterial) SetBlendDstAlpha(v int) {
	pm.Set("blendDstAlpha", v)
}
func (pm *PointsMaterial) BlendEquation() *BlendingEquation {
	return &BlendingEquation{Value: pm.Get("blendEquation")}
}
func (pm *PointsMaterial) SetBlendEquation(v *BlendingEquation) {
	pm.Set("blendEquation", v)
}
func (pm *PointsMaterial) BlendEquationAlpha() int {
	return pm.Get("blendEquationAlpha").Int()
}
func (pm *PointsMaterial) SetBlendEquationAlpha(v int) {
	pm.Set("blendEquationAlpha", v)
}
func (pm *PointsMaterial) BlendSrc() BlendingSrcFactor {
	return BlendingSrcFactor(pm.Get("blendSrc"))
}
func (pm *PointsMaterial) SetBlendSrc(v BlendingSrcFactor) {
	pm.Set("blendSrc", v)
}
func (pm *PointsMaterial) BlendSrcAlpha() int {
	return pm.Get("blendSrcAlpha").Int()
}
func (pm *PointsMaterial) SetBlendSrcAlpha(v int) {
	pm.Set("blendSrcAlpha", v)
}
func (pm *PointsMaterial) Blending() *Blending {
	return &Blending{Value: pm.Get("blending")}
}
...
func (pm *PointsMaterial) Color() *math.Color {
	return &math.Color{Value: pm.Get("color")}
}
func (pm *PointsMaterial) SetColor(v *math.Color) {
	pm.Set("color", v)
}
...
func (pm *PointsMaterial) DepthFunc() *DepthModes {
	return &DepthModes{Value: pm.Get("depthFunc")}
}
...
func (pm *PointsMaterial) Map() textures.Texture {
	return textures.Texture(pm.Get("map"))
}
func (pm *PointsMaterial) SetMap(v textures.Texture) {
	pm.Set("map", v)
}
...
func (pm *PointsMaterial) Opacity() int {
	return pm.Get("opacity").Int()
}
func (pm *PointsMaterial) SetOpacity(v int) {
	pm.Set("opacity", v)
}
func (pm *PointsMaterial) Overdraw() int {
	return pm.Get("overdraw").Int()
}
func (pm *PointsMaterial) SetOverdraw(v int) {
	pm.Set("overdraw", v)
}
...
func (pm *PointsMaterial) PolygonOffsetFactor() int {
	return pm.Get("polygonOffsetFactor").Int()
}
func (pm *PointsMaterial) SetPolygonOffsetFactor(v int) {
	pm.Set("polygonOffsetFactor", v)
}
func (pm *PointsMaterial) PolygonOffsetUnits() int {
	return pm.Get("polygonOffsetUnits").Int()
}
func (pm *PointsMaterial) SetPolygonOffsetUnits(v int) {
...
func (pm *PointsMaterial) Side() *Side {
	return &Side{Value: pm.Get("side")}
}
func (pm *PointsMaterial) SetSide(v *Side) {
	pm.Set("side", v)
}
func (pm *PointsMaterial) Size() int {
	return pm.Get("size").Int()
}
func (pm *PointsMaterial) SetSize(v int) {
	pm.Set("size", v)
}
...
func (pm *PointsMaterial) VertexColors() *Colors {
	return &Colors{Value: pm.Get("vertexColors")}
}
...
func (pm *PointsMaterial) Clone() this {
	return this(pm.Call("clone"))
}
func (pm *PointsMaterial) Copy(material *Material) this {
	return this(pm.Call("copy", material))
}
...
func (pm *PointsMaterial) OnBeforeCompile(shader shaders.Shader, renderer *renderers.WebGLRenderer) {
