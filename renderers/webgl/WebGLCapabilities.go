...
func NewWebGLCapabilities(gl *WebGLRenderingContext, extensions js.Value, parameters WebGLCapabilitiesParameters) *WebGLCapabilities {
...
func (wglc *WebGLCapabilities) GetMaxAnisotropy() int {
	return wglc.Call("getMaxAnisotropy").Int()
}
