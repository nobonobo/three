...
func (tbg *TubeBufferGeometry) Clone() BufferGeometry {
...
func (tbg *TubeBufferGeometry) Copy(source BufferGeometry) BufferGeometry {
	return &TubeBufferGeometry{Value: tbg.Call("copy", source.JSValue())}
}
