...
func (jsonl *JSONLoader) Handlers() LoaderHandler {
	return LoaderHandler(jsonl.Get("Handlers"))
}
func (jsonl *JSONLoader) SetHandlers(v LoaderHandler) {
	jsonl.Set("Handlers", v)
}
func (jsonl *JSONLoader) CreateMaterial(m *materials.Material, texturePath string, crossOrigin string) bool {
...
func (jsonl *JSONLoader) InitMaterials(materials []materials.Material, texturePath string) []materials.Material {
	return []materials.Material(jsonl.Call("initMaterials", materials, texturePath))
}
