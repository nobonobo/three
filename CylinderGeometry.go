...
func (cbg *CylinderBufferGeometry) Clone() BufferGeometry {
...
func (cbg *CylinderBufferGeometry) Copy(source BufferGeometry) BufferGeometry {
	return &CylinderBufferGeometry{Value: cbg.Call("copy", source.JSValue())}
}
